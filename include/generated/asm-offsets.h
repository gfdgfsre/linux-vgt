...
#define VCPU_FPEXC32_EL2 1992 /* offsetof(struct kvm_vcpu, arch.ctxt.sys_regs[FPEXC32_EL2]) */
#define VCPU_HOST_CONTEXT 3096 /* offsetof(struct kvm_vcpu, arch.host_cpu_context) */
