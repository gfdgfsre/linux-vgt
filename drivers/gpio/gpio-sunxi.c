...
#include <linux/soc/sunxi/sunxi-gpio.h>
#include <linux/io.h>
...
/**
  * #ifndef DEGUG_GPIO_SUNXI    
  * #define DEGUG_GPIO_SUNXI    1
  * #endif
  */
...
static int sunxi_init_gpio_probe(struct platform_device *pdev)
{
	...
	// commit by debug an port , needed to fix @2020.8.13.16.01
